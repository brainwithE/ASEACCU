	...
	<div class="smoothup-container">
		...
		<div class="footer">
			<div class="footer-top">
				<div class="container">
					<div class="col-xs-12 col-sm-6">
						<div class="col-xs-12 col-sm-4 col-md-2 footer-logo-container">
			...
			<div class="footer-bottom">
				<div class="container">
					<h6 class="copyright-left col-xs-12 col-sm-6 col-md-6">COPYRIGHT 2016.ASEACCU</h6>
					<h6  class="copyright-right col-xs-12 col-sm-6 col-md-6">BUILD WITH LOVE BY <a target="_blank" class="lnk" href="http://potatocodes.com">POTATOCODES INC.</a></h6>
				</div>
			</div>
		</div>
